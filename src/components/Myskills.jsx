      ...
      <div className="flex items-center justify-center gap-[5vw] bg-[#000111] w-full h-[100vh] p-[20vh]">
          ...
          <motion.h1 {...animations.h1}>
            {
              <>
                <div className="flex gap-6">
                  <div className="flex flex-col items-center justify-center bg-[#191919] h-[180px] w-[150px] pb-[5px] rounded-xl border-2 border-white">
                    <h1>
                      <svg
                        stroke="currentColor"
                        fill="currentColor"
                        ...
                        className="skill-svg text-[#88ab8e] h-[130px]"
                      >
                  ...
                  <div className="flex flex-col items-center justify-center bg-[#191919] h-[180px] w-[150px] pb-[5px] rounded-xl border-2 border-white">
                    <h1>
                      <svg
                        ...
                        class="skill-svg lucide lucide-database-zap"
                      >
                        <ellipse
                          cx="12"
                          cy="5"
        ...
        <div className="text-white">
          <motion.h1 {...animations1.h1}>
            {
              <>
                <h1 className="text-[1.2rem] font-semibold">MY SKILLS</h1>
                <h1 className="text-[3rem] flex gap-3 font-bold">
                  What <h1 className="text-[#88ab8e] font-bold">can I do </h1>
                </h1>
                <h1 className="text-[2rem] text-[#88ab8e] font-semibold">
                  <Typewriter
                    options={{
                      strings: [
                        "Frontend...",
                ...
                <br />
                <div className="flex flex-col gap-[17px] max-w-[40vw] text-[#dcdcdc] text-[18px]">
                  <h1>
                    As an adept developer, I possess a rich skill set covering
                    the spectrum of modern web development. In frontend
                    technologies, I am well-versed in HTML, CSS, and JavaScript,
                    the foundational pillars of web design. My proficiency
                    extends to advanced frontend frameworks like React.js,
                    empowering me to create dynamic and interactive user
                    interfaces with ease. Additionally, I leverage the power of
                    utility-first CSS frameworks such as Tailwind CSS and the
                    flexibility of Bootstrap to expedite development and ensure
                    UI consistency across projects.
                  </h1>
                  <h1>
                    On the backend, I excel in Node.js and Express.js, crafting
                    server-side applications that are not only high-performing
                    but also scalable and maintainable. Coupled with my
                    expertise in MongoDB, a leading NoSQL database, I design
                    efficient data models and implement robust data handling
                    mechanisms, ensuring seamless communication between the
                    frontend and backend layers.
                  </h1>
                  <h1>
                    In the realm of DevOps, I employ industry-standard tools
                    like Git and GitHub for version control, enabling efficient
                    collaboration and code management. Furthermore, I am
                    proficient in Docker, facilitating the creation, deployment,
